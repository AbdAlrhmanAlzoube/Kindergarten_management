                ...
                <div class="card-body">
                    ...
                    @endif
                        <div class="form-group">
                            <label for="user_first_name">Parent's First Name</label>
                            <input type="text" class="form-control @error('user_first_name') is-invalid @enderror" id="user_first_name" name="user_first_name" placeholder="Enter parent's first name">
